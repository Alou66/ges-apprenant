            ...
            <?php if (count($referentiels) > 0): ?>
                <?php foreach ($referentiels as $ref): ?>
                    <div class="elts">
                        ...
                        <div class="trvs"></div>
                        <div> <?= isset($ref['nombre_module']) ? htmlspecialchars((string) $ref['nombre_module']) : '0' ?> modules</div>

                        <div>Capacité : <?= isset($ref['nombre_apprenants']) ? htmlspecialchars((string) $ref['nombre_apprenants']) : '0' ?> places</div>

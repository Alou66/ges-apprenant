...
<body>
    ...
    <div class="a">
        ...
        <div class="grills2">
          <?php foreach ($promotions_finales as $promo) : ?>
                ...
                <div class="gr">
                    ...
                    <div class="apr">
                        ...
                        <div><?= $promo['nombre_apprenants'] ?>     apprenants<?= $promo['nombre_apprenants'] > 1 ? 's' : '' ?></div>
                    </div>
                    <div class="trx1"></div>
    ...
    <?php if ($current_page > 1) : ?>
        <a class="page-link" href="?page=proms1&page_num=<?= $current_page - 1 ?>">&laquo; Précédent</a>
    <?php endif; ?>

    <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
        <a class="page-link <?= $i === $current_page ? 'active' : '' ?>" href="?page=proms1&page_num=<?= $i ?>">
            <?= $i ?>
        </a>
    <?php endfor; ?>

    <?php if ($current_page < $total_pages) : ?>
        <a class="page-link" href="?page=proms1&page_num=<?= $current_page + 1 ?>">Suivant &raquo;</a>
    <?php endif; ?>
</div>
